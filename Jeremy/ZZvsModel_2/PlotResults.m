...
saveas(fig1,[dir_plot,'/figs/Convergence.fig'],'fig');
...
figure(fig1)
saveas(fig1,[dir_plot,'/figs/Temps.fig'],'fig');
...
figure(fig1)
saveas(fig1,[dir_plot,'/figs/Heating.fig'],'fig');
...
fig1.Children(4).Title.String = replace(fig1.Children(4).Title.String,'Fluid 2','Hot CO$_2$');
figure(fig1)
saveas(fig1,[dir_plot,'/figs/FluidTemps.fig'],'fig');
...
fig1.Children(4).Title.String = replace(fig1.Children(4).Title.String,'Fluid 2','Hot CO$_2$');
figure(fig1)
saveas(fig1,[dir_plot,'/figs/VelocityVectors.fig'],'fig');
...
figure(fig1)
saveas(fig1,[dir_plot,'/figs/BodyTemp.fig'],'fig');
