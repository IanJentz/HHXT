...
title('Effect of Area Ratio on Ineffectivness for Various C$_{r}$ (NTU=6.3096)','interpreter','latex')
...
title('Effect of NTU on Ineffectivness for Various C$_{r}$ (alpha=0.7)','interpreter','latex')
...
set(gca, 'XScale', 'log')
axis([1 100 -0.1 0.5])
saveas(figure(3),['figures','/','NTU for various C_r alpha 0.7','.png'],'png');  
...
title('Effect of NTU on Ineffectivness for Various $\alpha$ ($C_r$=0.7)','interpreter','latex')
xlabel('NTU $\left[ - \right]$','interpreter','latex')
ylabel('Ineffectiveness $\left[ - \right]$','interpreter','latex')
grid on
...
set(gca, 'XScale', 'log')
axis([1 100 -0.1 0.5])
saveas(figure(4),['figures','/','NTU for various alpha C_r 0.7','.png'],'png');  
...
title('Effect of Capacitance Ratio on Ineffectivness for Various $\alpha$ (NTU=6.3096)','interpreter','latex')
xlabel('Capacitance Ratio C$_{r}$ $\left[ - \right]$','interpreter','latex')
ylabel('Ineffectiveness $\left[ - \right]$','interpreter','latex')
grid on
legend(num2str(alpha_index(:)))
